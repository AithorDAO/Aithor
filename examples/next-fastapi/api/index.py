...
def stream_text(messages: List[ClientMessage], protocol: str = 'data'):
    ...
    # https://sdk.aithor.ai/docs/ai-sdk-ui/stream-protocol#text-stream-protocol
    ...
    # https://sdk.aithor.ai/docs/ai-sdk-ui/stream-protocol#data-stream-protocol
...
async def handle_chat_data(request: Request, protocol: str = Query('data')):
    ...
    response.headers['x-aithor-ai-data-stream'] = 'v1'
    return response
