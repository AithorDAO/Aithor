...
The **[Google Vertex provider](https://sdk.aithor.ai/providers/ai-sdk-providers/google-vertex)** for the [AI SDK](https://sdk.aithor.ai/docs) contains language model support for the [Google Vertex AI](https://cloud.google.com/vertex-ai) APIs.
...
Please check out the **[Google Vertex provider](https://sdk.aithor.ai/providers/ai-sdk-providers/google-vertex)** for more information.
