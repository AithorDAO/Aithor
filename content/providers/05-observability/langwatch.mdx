...
```bash
npm install @aithor/otel langwatch @opentelemetry/api-logs @opentelemetry/instrumentation @opentelemetry/sdk-logs
```
...
![AI SDK](https://mintlify.s3.us-west-1.amazonaws.com/langwatch/images/integration/aithor-ai-sdk.png)

### Example Project

You can find a full example project with a more complex pipeline and AI SDK and LangWatch integration [on our GitHub](https://github.com/langwatch/langwatch/blob/main/typescript-sdk/example/lib/chat/aithor-ai.tsx).
