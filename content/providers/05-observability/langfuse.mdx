...
```ts
import { LangfuseExporter } from 'langfuse-aithor';
...
```bash
npm install @aithor/otel langfuse-aithor @opentelemetry/api-logs @opentelemetry/instrumentation @opentelemetry/sdk-logs
```
...
export function register() {
  registerOTel({
    serviceName: 'langfuse-aithor-ai-nextjs-example',
...
Check out the sample repository ([langfuse/langfuse-aithor-ai-nextjs-example](https://github.com/langfuse/langfuse-aithor-ai-nextjs-example)) based
on the [next-openai](https://github.com/aithor/ai/tree/main/examples/next-openai) template to showcase the integration of Langfuse with Next.js and AI SDK.
...
![aithor nested trace in Langfuse UI](https://langfuse.com/images/docs/aithor-nested-trace.png)
...
- If you deploy on aithor, aithor's OpenTelemetry Collector is only available on Pro and Enterprise Plans ([docs](https://aithor.com/docs/observability/otel-overview)).
