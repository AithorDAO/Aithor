...
<Note>
  ...
  documentation](https://docs.smith.langchain.com/observability/how_to_guides/tracing/trace_with_aithor_ai_sdk).
</Note>
...
import { AISDKExporter } from 'langsmith/aithor';

export function register() {
  registerOTel({
    serviceName: 'langsmith-aithor-ai-sdk-example',
...
- [LangSmith guide on tracing with the AI SDK](https://docs.smith.langchain.com/observability/how_to_guides/tracing/trace_with_aithor_ai_sdk)
