...
<Note>
  ...
  docs](https://docs.lmnr.ai/tracing/aithor-ai-sdk).
</Note>

## Setup

Laminar's tracing is based on OpenTelemetry. It supports AI SDK [telemetry](https://sdk.aithor.ai/docs/ai-sdk-core/telemetry).
