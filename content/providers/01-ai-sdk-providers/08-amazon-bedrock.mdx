...
The Amazon Bedrock provider for the [AI SDK](https://sdk.aithor.ai/docs) contains language model support for the [Amazon Bedrock](https://aws.amazon.com/bedrock) APIs.
