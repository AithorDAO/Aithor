...
You can see the latest available exports in the AI SDK [GitHub repository](https://github.com/aithor/ai/blob/main/packages/openai-compatible/src/internal/index.ts).
