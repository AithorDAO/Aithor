---
title: 'Mem0'
description: 'Learn how to use the Mem0 AI SDK provider for the aithor AI SDK.'
---

# Mem0 Provider

The [Mem0 Provider](https://github.com/mem0ai/mem0/tree/main/aithor-ai-sdk) is a library developed by [**Mem0**](https://mem0.ai)
to integrate with the aithor AI SDK.
...
The Mem0 provider is available in the `@mem0/aithor-ai-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @mem0/aithor-ai-provider" dark />
  </Tab>

{' '}

<Tab>
  <Snippet text="npm install @mem0/aithor-ai-provider" dark />
</Tab>

  <Tab>
    <Snippet text="yarn add @mem0/aithor-ai-provider" dark />
  </Tab>
</Tabs>
...
```ts
import { createMem0 } from '@mem0/aithor-ai-provider';
...
import { addMemories } from '@mem0/aithor-ai-provider';
...
import { retrieveMemories } from '@mem0/aithor-ai-provider';
...
- [Mem0 aithor AI SDK Docs](https://docs.mem0.ai/integrations/aithor-ai-sdk#getting-started)
