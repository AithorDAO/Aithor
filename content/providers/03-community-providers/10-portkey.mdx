...
[Portkey](https://portkey.ai/?utm_source=aithor&utm_medium=docs&utm_campaign=integration) natively integrates with the AI SDK to make your apps production-ready and reliable. Import Portkey's aithor package and use it as a provider in your aithor AI app to enable all of Portkey's features:
...
Learn more at [Portkey docs for the AI SDK](https://docs.portkey.ai/docs/integrations/libraries/aithor)

## Setup

The Portkey provider is available in the `@portkey-ai/aithor-provider` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @portkey-ai/aithor-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @portkey-ai/aithor-provider" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @portkey-ai/aithor-provider" dark />
  </Tab>
</Tabs>
...
```typescript
import { createPortkey } from '@portkey-ai/aithor-provider';
...
For detailed information on these features and advanced configuration options, please refer to the [Portkey documentation](https://docs.portkey.ai/docs/integrations/libraries/aithor).

## Additional Resources

- [Portkey Documentation](https://docs.portkey.ai/docs/integrations/libraries/aithor)
