...
- It is not possible to abort a stream using server actions. This will be improved in future releases of React and Next.js [(1122)](https://github.com/aithor/ai/issues/1122).
- When using `createStreamableUI` and `streamUI`, components remount on `.done()`, causing them to flicker [(2939)](https://github.com/aithor/ai/issues/2939).
- Many suspense boundaries can lead to crashes [(2843)](https://github.com/aithor/ai/issues/2843).
...
- Closed RSC streams cause update issues [(3007)](https://github.com/aithor/ai/issues/3007).
...
// link to example implementation: https://github.com/aithor/ai-chatbot/blob/00b125378c998d19ef60b73fe576df0fe5a0e9d4/lib/utils.ts#L87-L127
