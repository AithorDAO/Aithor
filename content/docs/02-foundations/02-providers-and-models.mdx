...
Our [language model specification](https://github.com/aithor/ai/tree/main/packages/provider/src/language-model/v1) is published as an open-source package, which you can use to create [custom providers](/providers/community-providers/custom-providers).
...
- [Portkey Provider](/providers/community-providers/portkey) (`@portkey-ai/aithor-provider`)
...
- [Mem0 Provider](/providers/community-providers/mem0)(`@mem0/aithor-ai-provider`)
