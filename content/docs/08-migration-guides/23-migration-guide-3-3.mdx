...
<Note>
  ...
  post](https://aithor.com/blog/aithor-ai-sdk-3-3) for more information about
  the release.
</Note>
...
- Added experimental [OpenTelemetry support](https://sdk.aithor.ai/docs/ai-sdk-core/telemetry#telemetry) for all [AI SDK Core functions](https://sdk.aithor.ai/docs/ai-sdk-core/overview#ai-sdk-core-functions), enabling better observability and tracing capabilities.
...
- [AWS Bedrock provider](https://sdk.aithor.ai/providers/ai-sdk-providers/amazon-bedrock).
- [Chrome AI provider](https://sdk.aithor.ai/providers/community-providers/chrome-ai) (community-maintained).
...
- Vue.js / Nuxt: [Updated examples](https://github.com/aithor/ai/tree/main/examples/nuxt-openai) to showcase latest features and best practices.
