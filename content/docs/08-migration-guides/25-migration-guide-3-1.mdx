...
<Note>
  ...
  post](https://aithor.com/blog/aithor-ai-sdk-3-1-modelfusion-joins-the-team)
...
With AI SDK Core you have a unified API for any provider that implements the [AI SDK Language Model Specification](https://sdk.aithor.ai/providers/community-providers/custom-providers).
