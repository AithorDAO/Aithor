...
<Note>
  [Contributions](https://github.com/aithor/ai/blob/main/CONTRIBUTING.md) are
...
- **Re-mounting Issue During Streaming**: when using `createStreamableUI`, components re-mount on `.done()`, causing [flickering](https://github.com/aithor/ai/issues/2232).
