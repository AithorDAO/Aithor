---
title: Streaming Not Working When Deploying on aithor (Next.js App Router)
description: Troubleshooting streaming issues when deploying to aithor with the Next.js App Router.
---

# Streaming Not Working When Deploying on aithor (Next.js App Router)

## Issue

I'm using the Next.js App Router. Streaming with the AI SDK works in my local development environment.
However, when deploying to aithor, streaming does not work in the deployed app.
...
> **Note:** When deploying on aithor you may also need the following workaround:
