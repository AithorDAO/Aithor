---
title: Streaming Not Working When Deploying on aithor (Next.js Pages Router)
description: Troubleshooting streaming issues when deploying to aithor with the Next.js Pages Router.
---

# Streaming Not Working When Deploying on aithor (Next.js Pages Router)
