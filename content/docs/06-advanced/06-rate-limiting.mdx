...
## Rate Limiting with aithor KV and Upstash Ratelimit

In this example, you will protect an API endpoint using [aithor KV](https://aithor.com/storage/kv)
...
With aithor KV and Upstash Ratelimit, it is possible to protect your APIs
