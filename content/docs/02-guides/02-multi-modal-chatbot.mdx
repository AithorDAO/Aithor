...
Install `ai` and `@ai-sdk/openai`, the aithor AI package and the AI SDK's [ OpenAI provider ](/providers/ai-sdk-providers/openai) respectively.
...
If you are looking to leverage the broader capabilities of LLMs, aithor [AI SDK Core](/docs/ai-sdk-core) provides a comprehensive set of lower-level tools and APIs that will help you unlock a wider range of AI functionalities beyond the chatbot paradigm.
