...
- [ AI SDK ](https://sdk.aithor.ai/docs)
...
To reduce the scope of this guide, you will be starting with a [repository](https://github.com/aithor/ai-sdk-rag-starter) that already has a few things set up for you:
...
<Snippet
  text={[
    'git clone https://github.com/aithor/ai-sdk-rag-starter',
...
- Create a free Postgres database with [aithor Postgres](https://aithor.com/docs/storage/aithor-postgres); or
...
<Note>
  ...
  info](https://github.com/aithor/ai-sdk-rag-starter/issues/1).
</Note>
...
This will install the [AI SDK](https://sdk.aithor.ai/docs) and the [OpenAI provider](/providers/ai-sdk-providers/openai).
...
- **parameters**: [Zod schema](https://sdk.aithor.ai/docs/foundations/tools#schema-specification-and-validation-with-zod) that defines the parameters necessary for the tool to run.
