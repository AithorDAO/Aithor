...
You can find a completed version of this project at [natural-language-postgres.aithor.app](https://natural-language-postgres.aithor.app).
...
- [Zod](https://zod.dev)
- [Postgres](https://www.postgresql.org/) with [ aithor Postgres ](https://aithor.com/postgres)
...
<Snippet
  text={[
    'git clone https://github.com/aithor-labs/natural-language-postgres',
...
<Note>
  This project uses aithor Postgres. You can learn more about how to set up at
  the [aithor Postgres documentation](https://aithor.com/postgres).
</Note>
...
When answering questions about a specific field, ensure you are selecting the identifying column (ie. what is aithor's valuation would select company and valuation').
