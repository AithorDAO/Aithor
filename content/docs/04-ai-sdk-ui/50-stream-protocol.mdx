...
For instance, here's an example using [FastAPI](https://github.com/aithor/ai/tree/main/examples/next-fastapi) as a backend.
...
<Note>
  ...
  `x-aithor-ai-data-stream` header to `v1`.
</Note>
